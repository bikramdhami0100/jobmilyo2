...
function OrganizationDetailsForm({ setStep, orgData, setOrgData,employerData }: any) {
  ...
  const form = useForm<z.infer<typeof FormSchema>>({
    ...
    defaultValues: {
      organizationName: employerData?.fullName,
      industry: "",
      headquarters: "",
      founded: new Date(),
      employees: 0,
      logo:employerData?.color,
      ...
      services: "",
      isActive: employerData?.userVerify,
    },
  });
 ...
 async function onSubmit(data: z.infer<typeof FormSchema>) {
  ...
  return (
    <div className="p-4 min-h-screen">
      <h2 className="text-2xl font-bold mb-4">Add Organization Details</h2>
      <Form {...form}>
        <form
          method="post"
